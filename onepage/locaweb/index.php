...
$mail->Host = 'smtp.espacolp.com.br';  	// Servidor smtp 
$mail->SMTPAuth = true;                 // Habilita a autenticação do form
$mail->Username = 'contato@espacolp.com.br';       // Conta de e-mail que realizará o envio
$mail->Password = 'topazio258lp';       // Senha da conta de e-mail
//$mail->SMTPSecure = 'tls';            // Habilitar uso do TLS (plesk 11.5 ou utilizando contas do Gmail)
$mail->Port = 587;                       // Porta de conexão 
$mail->From = 'contato@espacolp.com.br'; 			// e-mail From deve ser o mesmo de "username" (contadeEmail)
$mail->FromName = 'Teste'; 				// Nome que será exibido ao receber a mensagem. 
$mail->addAddress('contato@espacolp.com.br', 'NOME DESTINATARIO'); // Destinatário 
...
$mail->Body    = 'ESSA MENSAGENS MESMO QUE TEM QUE CHEGAR :D</b>'; // Corpo da mensagem
